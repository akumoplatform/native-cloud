...
(function(window) {
	...
	jQuery.get("http://localhost:7979/html/hystrixThreadPool.html", function(data) {
		htmlTemplate = data;
	});
	jQuery.get("http://localhost:7979/html/hystrixThreadPoolContainer.html", function(data) {
